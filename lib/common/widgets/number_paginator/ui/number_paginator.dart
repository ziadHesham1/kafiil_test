...
import '../ui/widgets/buttons/paginator_button.dart';
...
class NumberPaginator extends StatefulWidget {
  ...
  final Widget beginningButtonContent;
  ...
  const NumberPaginator({
    ...
    this.beginningButtonContent = const Icon(Icons.fast_rewind_outlined),
  ...
  const NumberPaginator.noPrevNextButtons({
    ...
    this.controller,
        ...
        beginningButtonContent = const SizedBox(),
          ...
          children: [
            if (widget.showPrevButton)
              widget.prevButtonBuilder?.call(context) ??
                  PaginatorButton(
                    onPressed: _controller.beginning,
                    child: Image.asset('assets/icons/First.png'),
                  ),
